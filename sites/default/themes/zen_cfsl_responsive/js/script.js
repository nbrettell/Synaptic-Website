...
//		        pagerNumber = parseInt(pagerNumber);
		...
		if ($('#block-menu-block-4 li.menu-mlid-735' || '#block-menu-block-4 li.menu-mlid-736' || '#block-menu-block-4 li.menu-mlid-737' || '#block-menu-block-4 li.menu-mlid-738' || '#block-menu-block-4 li.menu-mlid-739' || '#block-menu-block-4 li.menu-mlid-740' ).length > 0) {
		...
		// CCD
		if ($('#block-menu-block-4 li.menu-mlid-735').length > 0) {
			$('a.logo-ccd').css( 'display', 'inline-block' );
		}
		// Comparator
		if ($('#block-menu-block-4 li.menu-mlid-736').length > 0) {
			$('a.logo-comparator').css( 'display', 'inline-block' );
		}
		// Illustrator
		if ($('#block-menu-block-4 li.menu-mlid-737').length > 0) {
			$('a.logo-illustrator').css( 'display', 'inline-block' );
		}
		// Modeller
		if ($('#block-menu-block-4 li.menu-mlid-738').length > 0) {
			$('a.logo-modeller').css( 'display', 'inline-block' );
		}
		// Product & Fund
		if ($('#block-menu-block-4 li.menu-mlid-739').length > 0) {
			$('a.logo-product').css( 'display', 'inline-block' );
		}
		// Webline
		if ($('#block-menu-block-4 li.menu-mlid-740').length > 0) {
